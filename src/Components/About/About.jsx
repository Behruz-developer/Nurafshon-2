          ...
          <div className="about_card_icons" data-aos="fade-left">
            <div className="about_card_icon">
              ...
              <div className="about_icon_text">
                <div className="about_icon_text_card">
                  <svg className="about_icon_text_img" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M2 17.793H2.93001C4.38001 17.793 5.56 18.983 5.56 20.423V32.123C5.56 33.573 4.37001 34.753 2.93001 34.753H2V17.793Z" stroke="#01512e" stroke-width="1.1999" stroke-miterlimit="22.9256" stroke-linecap="round" />
                    <path d="M8.72006 21.0723H5.56006V31.4823H8.72006V21.0723Z" stroke="#01512e" stroke-width="1.1999" stroke-miterlimit="22.9256" stroke-linecap="round" />
                    <path d="M29.5801 21.413L26.8201 26.183C21.1401 22.903 16.0001 19.933 10.3101 16.653C8.35007 15.523 8.21008 14.063 8.99008 12.713L10.3401 10.373L29.5801 21.413Z" stroke="#01512e" stroke-width="1.1999" stroke-miterlimit="22.9256" stroke-linecap="round" />
                    <path d="M38.0199 17.7429L34.2999 24.1929L10.3398 10.3729C11.2398 8.82287 11.7498 7.93287 12.6398 6.38287C13.1998 5.40287 14.6799 4.35287 16.6599 5.50287L38.0199 17.7429Z" stroke="#01512e" stroke-width="1.1999" stroke-miterlimit="22.9256" stroke-linecap="round" />
                    <path d="M10.8301 13.7539L14.7101 15.9939" stroke="#01512e" stroke-width="1.1999" stroke-miterlimit="22.9256" stroke-linecap="round" />
                    <path d="M27.71 24.6428C27.71 24.6428 29.1199 25.5228 30.7599 24.9928C32.3999 24.4728 32.8999 23.3828 32.8999 23.3828" stroke="#01512e" stroke-width="1.1999" stroke-miterlimit="22.9256" stroke-linecap="round" />
                    <path d="M8.73047 27.9728H12.6605C13.9605 27.9728 15.5505 27.9528 17.0705 26.8728C18.6005 25.7928 19.4805 23.5628 20.2405 22.3828" stroke="#01512e" stroke-width="1.1999" stroke-miterlimit="22.9256" stroke-linecap="round" />
                    <path d="M8.73047 24.5326H12.3105C13.2905 24.5326 14.1205 24.6126 15.0705 23.9826C16.0305 23.3526 16.8905 21.3226 17.2205 20.6426" stroke="#01512e" stroke-width="1.1999" stroke-miterlimit="22.9256" stroke-linecap="round" />
                    <path d="M32.9998 17.5938C33.8198 17.5938 34.4898 18.2638 34.4898 19.0838C34.4898 19.9038 33.8198 20.5738 32.9998 20.5738C32.1798 20.5738 31.5098 19.9038 31.5098 19.0838C31.5098 18.2638 32.1798 17.5938 32.9998 17.5938Z" stroke="#01512e" stroke-width="1.1999" stroke-miterlimit="22.9256" stroke-linecap="round" />
                  </svg>
              ...
              <div className="about_icon_text">
                <div className="about_icon_text_card" >
                  <img src={about2} className="about_icon_text_img" alt="" />
                </div>
                Ko'p funksiyali <br /> hovli
              </div>
              <div className="about_icon_text">
                <div className="about_icon_text_card" >
                  <img src={about3} alt="" className="about_icon_text_img" />
                </div>
                Yopiq va xavfsiz
                hovli
              </div>
